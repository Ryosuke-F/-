...
class BWWalkthroughPageViewController: UIViewController, BWWalkthroughPage {
    ...
    @IBOutlet weak var truthLabel1: UILabel!
    @IBOutlet weak var dareLabel1: UILabel!
    
    @IBOutlet weak var truthLabel2: UILabel!
    @IBOutlet weak var dareLabel2: UILabel!
    
    @IBOutlet weak var truthlabel3: UILabel!
    @IBOutlet weak var dareLabel3: UILabel!
